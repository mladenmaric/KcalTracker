...
class DatabaseHelper {
  ...
  Future<void> _seedSerbianFoods(Database db) async {
    final foods = [
      ...
      ('100% Whey Protein Professional White Chocolate, Scitec Nutrition', 380, 72, 8.4, 6.2),
      ('100% Whey Protein Professional Chocolate Coconut, Scitec Nutrition', 380, 73, 8.1, 5.9),
      ('100% Whey Protein Professional Cookies & Cream, Scitec Nutrition', 382, 74, 8, 5.8),
      ('100% Whey Protein Professional Čokolada, Scitec Nutrition', 382, 73, 8.4, 5.9),
      ('100% Whey Protein Professional Strawberry, Scitec Nutrition', 380, 72, 9.2, 5.6),
      ('100% Whey Protein Professional Vanila, Scitec Nutrition', 380, 73, 9.4, 5.6),
      ('ABC supa dehidrirana Maggi', 317, 10.2, 61.1, 2.8),
      ('ABC svježi krem sir Belje', 241, 6.5, 3, 22.5),
      ('Acerola', 32, 0.4, 7.69, 0.3),
      ('Agavin sirup', 310, 0.09, 76.37, 0.45),
      ...
      ('Anis sjeme', 337, 17.6, 50.02, 15.9),
      ...
      ('Bademovo mlijeko', 15, 0.59, 0.58, 1.1),
      ('Bademovo mlijeko, Alpro', 24, 0.5, 3, 1.1),
      ('Bademovo mlijeko, okus čokolada', 50, 0.63, 9.38, 1.25),
      ('Bademovo mlijeko, okus vanilija', 38, 0.42, 6.59, 1.04),
      ...
      ('Biskvit čokoladni, Milka', 454, 5.6, 58, 22),
      ('Bjelance (belance), kokošje', 52, 10.9, 0.73, 0.17),
      ('Black Forest Mix, Volim Tropic', 42, 0.9, 8.2, 0.1),
      ('Blitva', 19, 1.8, 3.74, 0.2),
      ('Blitva kuvana', 20, 1.88, 4.13, 0.08),
      ('Bob mahune', 88, 7.92, 17.63, 0.73),
      ('Bob sjemenke', 341, 26.12, 58.29, 1.53),
      ('Bok Čoj', 13, 1.5, 2.2, 0.2),
      ('Bomboni karamele', 382, 4.6, 77, 8.1),
      ('Bomboni pjenasti, Bebeto', 327, 4.5, 77, 0),
      ('Bomboni tvrdi', 394, 0, 98, 0.2),
      ('Bomboni gumeni, Malaco', 349, 0, 85, 0.3),
      ('Bombonjera, Paradis, Marabou', 530, 4.1, 58, 31),
      ('Bombonjera, Toffifee, STORCK', 522, 6, 59, 28.8),
      ('Borovnice (Blueberries)', 57, 0.74, 14.49, 0.33),
      ('Bosiljak list, suvi (Dried Basil)', 233, 22.98, 47.75, 4.07),
      ('Bosiljak list, svjež (Fresh Basil)', 23, 3.15, 2.65, 0.64),
      ('Brašno od kokosa (Coconut Flour)', 361, 20, 20, 15),
      ('Brašno, krumpirovo (Potato Starch)', 357, 6.9, 83.1, 0.34),
      ('Braskva (Peach)', 39, 0.91, 9.54, 0.25),
      ('Brokoli kuvana (Cooked Broccoli)', 35, 2.38, 7.18, 0.41),
      ('Brusnica, suva (Dried Cranberry)', 308, 0.17, 82.8, 1.09),
      ('Bubrezi goveđi (Beef Kidney)', 99, 17.4, 0.29, 3.09),
      ...
      ('Bundeva (tikva...) pulpa, kuvana, ocijeđena, soljena', 18, 0.72, 4.31, 0.07),
      ('Bundeva (tikva...), pečena', 46, 1.08, 7.94, 1.75),
      ('Bundeva (tikva...) pulpa, kuvana, ocjeđena, bez soli', 20, 0.72, 4.9, 0.07),
      ('Burek', 375, 8, 27.5, 25),
      ...
      ('Ćevapi bez lepinje - goveđe/juneće meso', 230, 19.28, 3.72, 15.45),
      ('Ćevapi bez lepinje - svinjsko/goveđe meso', 263, 17.88, 3.72, 19.75),
      ('Ćevapi u lepinji', 924, 49.3, 85.6, 42),
      ('Chocolate Crisp Balls', 539, 6.8, 57.5, 31.1),
      ('Čia (chia) sjemenke', 486, 16.54, 42.12, 30.74),
      ('Čičoka', 73, 2, 17.44, 0.01),
      ('Čili Bili', 514, 12.3, 40.6, 32.6),
      ('Cimet', 247, 3.99, 80.59, 1.24),
      ('Cipal', 117, 19.35, 0, 3.79),
      ('Čips od krompira', 532, 6.39, 53.83, 33.98),
      ('Čips od riže', 381, 4.67, 83.6, 3),
      ('Coca cola', 44, 0, 12, 0),
      ...
      ('Čokolada, mliječna, punjena kremom obranog mlijeka i jogurta sa okusom jagoda, Milka', 552, 4.6, 57, 34),
      ...
      ('Čokoladni tartufi', 599, 4.2, 41, 45),
      ('Čokoladno mlijeko 1% mm, Moja Kravica, Imlek', 62, 3.3, 10, 1),
      ('Čokoladno mlijeko, Dukat', 63, 2.3, 10.7, 1.1),
      ('Čokoladno mlijeko, punomasno', 92, 3, 10, 4),
      ...
      ('Cvekla kuvana, konzervisana', 32, 1.1, 7, 0.1),
      ('Dagnje', 86, 11.9, 3.69, 2.24),
      ('Dagnje kuvane', 172, 23.8, 7.39, 4.48),
      ('Datulja', 142, 2.6, 36.6, 0.6),
      ('Datulja sušena', 282, 2.45, 75.03, 0.39),
      ('Datulja Medjoul, Avgerinos', 290, 2.7, 69.8, 0.5),
      ...
      ('Divljač, zečetina', 114, 21.79, 0, 2.32),
      ('Dobra ovsena kaša - čokolada', 428, 6.8, 66, 14),
      ('Dobra ovsena kaša - jabuka i cimet', 425, 6.3, 68, 13),
      ('Dobra Zobena kaša - šumsko voće', 413, 8, 65, 12),
      ('Domaće kore za pite, Fantasy', 263.96, 8.6, 55.1, 0.3),
      ('Domaći ajvar, ljuti, Vitaminka', 123, 1.4, 14, 6.8),
      ('Dresing sa jogurtom', 200, 2.1, 11, 16),
      ('Dresing sa začinskim biljem', 25, 0.1, 5.2, 0.1),
      ('Dud (murva)', 43, 1.44, 9.8, 0.39),
      ('Dunja', 57, 0.4, 15.3, 0.1),
      ('Duo Mix - indijski orašćić/brusnica', 418, 5.8, 63.7, 16.6),
      ('Dvopek - paradajz, maslina, origano', 449, 14, 63, 15),
      ('Dvopek - bijelo brašno', 392, 11.5, 72, 5),
      ('Dvopek - Granetti Classici', 420, 10, 69.9, 10),
      ...
      ('Granola domaća sa suvim voćem', 401, 10.2, 53.5, 17.6),
      ...
      ('Guma za žvakanje, bez šećera', 268, 0, 94.8, 0.4),
      ('Gumeni bomboni', 396, 0, 98.9, 0),
      ('Guska (samo meso)', 161, 22.75, 0, 7.13),
      ('Guska, cijela', 371, 15.86, 0, 33.62),
      ('Hamburger', 360, 14, 4, 32),
      ('Haringa atlantska', 158, 17.96, 0, 9.04),
      ('Heljda', 343, 13.25, 71.5, 3.4),
      ...
      ('Hljeb kukuruzni žuti domaći', 418, 7, 69.5, 12.2),
      ...
      ('Hljeb, Tost, Protein Plus, Klas', 258, 14.1, 37.59, 5.78),
      ...
      ('Jaje kokošje, kajgana', 167, 11.15, 2.13, 12.13),
      ('Jaje kokošje, kuvano', 144, 12.6, 0.8, 9.6),
      ('Jaje pačje', 185, 12.81, 1.45, 13.77),
      ('Jaje prepelice', 158, 13.05, 0.41, 11.09),
      ('Jaje pureće', 171, 13.68, 1.15, 11.88),
      ('Jaje kokošje, pečeno', 143, 12.6, 0.08, 8.7),
      ('Jakopska kapica', 69, 12.06, 3.18, 0.49),
      ('Jam', 118, 1.53, 27.88, 0.17),
      ('Janjetina nemasna', 243, 17.54, 0, 18.66),
      ...
      ('Jogurt voćni, Smoothie, b Aktiv', 71, 2.7, 12.1, 1.1),
      ('Jogurt voćni, šumsko voće, Freska', 88, 2.8, 14.3, 2.2),
      ('Jogurt, 0,9% mm', 45, 4.3, 5.1, 0.9),
      ('Jogurt, b Aktiv, LGG, Dukat', 47, 3.4, 4.9, 1.5),
      ('Jogurt, balans + protein 0% mm', 36, 4, 4, 0.05),
      ('Kačkavalj', 389, 25, 0, 32.14),
      ('Kafa, espreso', 9, 0.12, 1.67, 0.18),
      ...
      ('Keks (Cookies), dupla čokolada, Merba', 498, 6.6, 59, 25),
      ...
      ('Keks, Wellness integralni, Bambi', 453, 9.9, 58.2, 18.1),
      ...
      ('Keleraba, kuvana (barena), ocijeđena, bez soli', 29, 1.8, 6.69, 0.11),
      ('Keleraba, kuvana, ocijeđena, soljena', 29, 1.8, 6.69, 0.11),
      ('Kelj', 27, 2, 6.1, 0.1),
      ('Kelj papučar (prokulica)', 43, 3.38, 8.95, 0.3),
      ('Kesten', 213, 2.42, 45.54, 2.26),
      ('Kikiriki puter sa komadićima, sa soli', 589, 24.06, 21.57, 49.94),
      ('Kikiriki puter Smooth, McEnnedy', 651, 27, 9.3, 55),
      ('Kikiriki puter pasta, Body&Fit', 639, 27, 10, 53),
      ('Kikiriki puter u prahu, Gym Beam', 459, 50, 33, 12),
      ('Kikiriki u ljusci', 565, 25.8, 16.25, 49.11),
      ('Kikiriki, Nic Nac, Lorenz', 543, 17, 37, 35),
      ('Kikiriki suvo-pečeni, bez soli', 587, 24.35, 21.26, 49.66),
      ('Kikiriki suvo-pečeni, slani', 587, 24.35, 21.26, 49.66),
      ('Kim sjeme', 333, 19.77, 49.9, 14.59),
      ('Kinder Cards', 510, 11.5, 55.9, 26.3),
      ('Kinder Country', 561, 8.6, 54.9, 33.8),
      ('Kinder Maxi King', 521, 6.7, 38.2, 37.5),
      ('Kinoa', 368, 14.12, 64.16, 6.07),
      ('Kinoa, kuvana', 120, 4.4, 21.3, 1.92),
      ('Kisela pavlaka 12%', 138, 2.9, 4.5, 12),
      ('Kisela pavlaka 18%', 192, 3, 3, 18),
      ('Kisela pavlaka 20%, Dukat', 206, 2.7, 3.9, 20),
      ('Kisela pavlaka 25%, Dukat', 248, 2.5, 3.2, 25),
      ('Kisela pavlaka mileram 22%, Dukat', 224, 2.6, 3.9, 22),
      ('Kisela pavlaka mileram 30%, Dukat', 290, 2.3, 2.8, 30),
      ...
      ('Kokošija kocka pripremljena 100 ml', 7, 0.36, 0.24, 0.48),
      ...
      ('Kokosovo brašno, sa šćerom', 501, 2.88, 47.67, 35.49),
      ('Kokosovo brašno, Topingo', 659, 6.7, 24.3, 64.6),
      ('Kokosovo mlijeko', 230, 2.29, 5.54, 23.84),
      ('Kokosovo mlijeko, konzervirano', 197, 2.02, 2.81, 21.33),
      ('Komorač korijen', 31, 1.24, 7.3, 0.2),
      ('Komorač sjeme', 345, 15.8, 52.29, 14.87),
      ...
      ('Kondenzovano mlijeko, zaslađeno', 328, 7.2, 56.5, 8.1),
      ('Konjetina (srednje masno)', 110, 20.9, 0, 2.8),
      ('Kopriva, obarena', 42, 2.71, 7.49, 0.11),
      ('Kore za tortu, Vincinni', 358, 10, 78, 3.5),
      ('Kore za pitu, jufke, tijesto za savijače, heljdino brašno, svježe', 291, 8.7, 55, 1.1),
      ('Kore za pitu, jufke, tijesto za savijače, integralne, svježe', 291, 11.56, 59.17, 0.9),
      ('Kore za pitu, jufke, tijesto za savijače, svježe', 220, 5.6, 64.6, 1.9),
      ...
      ('Krem namaz sa lješnjacima, Bonno Premium, Pionir', 440, 7.6, 57, 31),
      ('Krem namaz sa lješnjacima, Maza', 537, 6.4, 52.7, 32.4),
      ('Krem namaz, Lino Lada, Gold, Podravka', 530, 6.2, 57, 30),
      ('Krem pileća juha, fini-mini, Podravka', 67, 2.3, 8.8, 2.2),
      ('Krem sir, Arla', 252, 4.5, 3, 25),
      ('Krem sirni namaz, Labne', 189, 4.5, 4.5, 17),
      ('Krompir', 77, 2.05, 17.49, 0.09),
      ('Kroasani', 410, 5, 35, 25),
      ('Krompir pire sa mlijekom i maslacem', 113, 1.86, 16.81, 4.22),
      ('Krompir pire sa mlijekom', 83, 1.91, 17.57, 0.57),
      ('Kruška', 57, 0.36, 15.23, 0.14),
      ('Kruška sušena', 262, 1.87, 69.7, 0.63),
      ('Krvavice', 380, 14.8, 1.2, 34.4),
      ('Kukuruz bijeli u zrnu', 365, 9.42, 74.26, 4.74),
      ('Kukuruz žuti slatki konzervirani', 112, 3, 20.5, 1.3),
      ('Kukuruz žuti slatki', 86, 3.27, 18.7, 1.35),
      ('Kukuruz žuti slatki konzervisan', 67, 2.29, 14.34, 1.22),
      ('Kukuruz žuti slatki kuvan', 96, 3.41, 20.98, 1.5),
      ('Kukuruzna krupica palenta', 349, 7, 79, 2),
      ('Kukuruzne pahuljice', 357, 7.5, 84.1, 0.4),
      ...
      ('Kupus kiseli', 18, 3.57, 3.57, 0.0),
      ('Kupus, glavica, crveni', 31, 7.37, 1.43, 0.16),
      ('Kupus, glavica, zeleni', 25, 5.8, 1.28, 0.1),
      ('Kupus, kineski', 13, 2.18, 1.5, 0.2),
      ('Kupus, zeleni, kuvan, soljen, ocijeđen', 23, 5.51, 1.27, 0.06),
      ('Kurkuma (indijski šafran)', 312, 67.14, 9.68, 3.25),
      ('Kuskus', 376, 77.43, 12.76, 0.64),
      ('Kuskus, kuvan', 112, 23.22, 3.79, 0.16),
      ('Kvasac, suvi (suhi)', 325, 41.22, 40.44, 7.61),
      ('Kvasac, svjež', 105, 18.1, 8.4, 1.9),
      ('Lan (laneno) sjeme', 534, 28.88, 18.29, 42.16),
      ('Leća (sočivo)', 352, 63.35, 24.63, 1.06),
      ('Leća (sočivo), crvena (roza)', 358, 63.1, 23.91, 2.17),
      ('Leća (sočivo), kuvana sa soli', 114, 19.54, 9.02, 0.38),
      ...
      ('Ljute papričice (feferoni) crvene, čili', 40, 1.87, 8.81, 0.44),
      ('Ljute papričice (feferoni) zelene, čili', 40, 2, 9.46, 0.2),
      ('Loj goveđi', 902, 0.0, 0.0, 100),
      ('Loj ovčiji', 902, 0.0, 0.0, 100),
      ('Losos', 208, 20.42, 0.0, 13.42),
      ('Losos, konzerviran, Losos Ustka', 173, 12, 10, 9),
      ('Lubenica', 30, 0.61, 7.55, 0.15),
      ('Lubin (brancin)', 97, 19.3, 0.0, 2),
      ('Luk bijeli (beli)', 149, 6.36, 33.06, 0.5),
      ('Luk crveni (crni)', 40, 1.1, 9.34, 0.1),
      ('Luk mladi', 27, 0.97, 5.74, 0.47),
      ('Mahune (boranija, buranija), zelene', 31, 1.83, 6.97, 0.22),
      ('Mahune zelene, smrznute, Ledo', 39, 1.8, 7.5, 0.21),
      ('Mahune (boranija, buranija), žute', 31, 1.82, 7.13, 0.12),
      ('Majonez lajt (light)', 238, 0.37, 9.23, 22.22),
      ('Majonez lajt, Polimark', 250, 0.0, 8.5, 24),
      ('Majonez, Light, Zvijezda', 394, 0.5, 6.1, 41),
      ('Majonez, obični', 680, 0.96, 0.57, 74.85),
      ('Majonez, Polimark', 705, 1.1, 2.6, 77),
      ('Makadamia orah', 718, 7.91, 13.82, 75.77),
      ('Makarone sa sirom', 233.9, 9.7, 26.6, 9.8),
      ('Makarone, tjestenina, Pasta Ricco', 356, 11, 74, 1.1),
      ('Malina', 52, 1.2, 11.94, 0.65),
      ('Malina, smrznuta, Ledo', 25, 0.9, 5.6, 0.0),
      ('Maltodextrin, My protein', 380, 0.0, 94, 0.0),
      ...
      ('Mast biljna', 884, 0.0, 0.0, 99.97),
      ('Mast guščija', 900, 0.0, 0.0, 99.8),
      ('Mast kokošja', 900, 0.0, 0.0, 99.8),
      ('Mast pačja', 882, 0.0, 0.0, 99.8),
      ('Mast pureća', 900, 0.0, 0.0, 99.8),
      ('Mast svinjska', 902, 0.0, 0.0, 100),
      ('Matična mleč (mliječ)', 310, 0.0, 76.19, 0.0),
      ('Matovilac (repušac)', 21, 2, 3.6, 0.4),
      ('Med', 304, 0.3, 82.4, 0.0),
      ('Medenjak čokoladni, Medeno Srce, Pionir', 340, 5.7, 66.1, 8.5),
      ('Mediteranska salata sa tunjevinom', 164, 7.1, 3.5, 13),
      ('Mekinje, pšenične', 206, 14.1, 26.8, 5.5),
      ('Mekinje, zobene (ovsene)', 246, 17.3, 66.22, 7.03),
      ('Meksička mješavina', 52, 2.3, 7.9, 0.5),
      ('Meso jelena i srnetina', 120, 22.96, 0.0, 2.42),
      ('Mirođija (kopar) list, suvi', 253, 19.96, 55.82, 4.36),
      ('Mirođija (kopar) list, svjež', 43, 3.46, 7.02, 1.12),
      ('Mirođija (kopar) sjeme', 305, 15.98, 55.17, 14.54),
      ...
      ('Mlijeko kravlje 0,9% mm', 40, 3.2, 4.7, 0.9),
      ('Mlijeko kravlje 0% mm, Lagano Jutro, Dukat', 32, 3.3, 4.6, 0.1),
      ('Mlijeko kravlje 1,5% mm, bez laktoze, Alpsko Mleko', 46, 3.3, 4.7, 1.5),
      ('Mlijeko kravlje 1,8% mm', 49, 3.5, 5, 1.8),
      ('Mlijeko kravlje 1% mm, Vindija', 41, 3.2, 4.7, 1),
      ...
      ('Mlijeko (mleko), ovčije', 108, 5.98, 5.36, 7.0),
      ('Mlijeko kravlje kiselo, 2,8% mm, Meggle', 54, 3.0, 3.6, 2.8),
      ('Mljeveno, miješano meso', 210, 18.8, 0.0, 15.4),
      ('Monte Snack, Zott', 443, 5.0, 35.5, 31.0),
      ('Morski pas (ajkula)', 130, 20.98, 0.0, 4.51),
      ('Morski pas (ajkula), pečen', 228, 18.6, 6.35, 13.76),
      ('Mortadela', 415, 13.9, 0.0, 39.9),
      ('Mozak, svinjski, svjež', 127, 10.28, 0.0, 9.21),
      ('Mrena', 84, 14.0, 0.1, 3.1),
      ('Mrvice hljebne, suve', 395, 13.35, 71.98, 5.3),
      ('Muesli (prosjek)', 314, 11.4, 55.8, 6.4),
      ('Munchmallow', 416, 4.3, 60.5, 16.9),
      ('Murina', 99, 17.6, 1.3, 2.7),
      ('Muskatni oraščić (orah), muskat, muškat, mljeveni', 525, 5.84, 49.29, 36.31),
      ...
      ('Origano (mravinac), suvi', 265, 9, 68.92, 4.28),
      ('Oslić', 71, 17, 0.1, 0.3),
      ('Oslić fileti', 118, 18, 0.0, 5.13),
      ('Ovčetina', 293, 17, 0.0, 25),
      ('Pahuljice (krupne), zobene', 402, 14, 66, 7),
      ('Pahuljice (sitne), zobene', 360, 12.5, 57, 7),
      ('Pahuljice, ječmene', 357, 10.18, 73.61, 2.24),
      ('Pahuljice, ražene, instant', 327, 9.7, 62, 1.5),
      ...
      ('Panirani fišburger', 142, 7.9, 23.3, 1.4),
      ...
      ('Paradajz sos, koncentrat, 28-30%, Podravka', 84, 4.6, 16, 0.16),
      ('Paradajz čeri (cherry)', 21, 1.47, 4.41, 0.3),
      ('Paradajz sos (koncentrat 10)', 39, 1.7, 7, 0.0),
      ('Paradajz, rajčica', 18, 0.88, 3.92, 0.2),
      ('Parmezan', 411, 40, 2, 27),
      ('Parmezan, Grana Padano', 398, 33, 0.0, 29),
      ...
      ('Pastrmka filet, dimljena', 113, 21.1, 3.4, 1.4),
      ('Pastrmka filet, dimljena - Tropic', 137, 21.27, 0.5, 5.8),
      ('Pastrmka kalifornijska', 195, 21.5, 0.0, 11.4),
      ('Pastrmka pečena', 169, 24.3, 0.0, 7.2),
      ('Pastrmka potočna', 86, 14.7, 0.0, 3),
      ('Pasulj mladi šareni smrznuti', 170, 9.8, 32.5, 0.5),
      ('Pasulj bijeli tetovac', 333, 23.36, 60.27, 0.85),
      ('Pasulj crni', 341, 21.6, 62.36, 1.42),
      ('Pasulj crveni', 337, 22.53, 61.29, 1.06),
      ('Pasulj šareni trešnjevac', 347, 21.42, 62.55, 1.23),
      ('Pasulj šareni kuvan soljen', 143, 9.01, 26.22, 0.65),
      ('Patka samo meso', 122, 19.7, 0.0, 4.8),
      ('Patka srednje masna', 341, 20, 0.0, 29),
      ('Patka divlja', 211, 17.42, 0.0, 15.2),
      ('Patlidžan', 25, 0.98, 5.88, 0.18),
      ('Pečenica dimljena svinjska', 228, 33, 2.8, 9.4),
      ('Pecivo bijelo brašno', 256, 8, 47, 4),
      ('Pecivo za hamburgere sa susamom', 295, 7.8, 52.6, 5.4),
      ...
      ('Pica sa kobasicom', 255, 14.225, 28.028, 9.86),
      ('Pica sa sirom', 267, 12.06, 32.38, 9.68),
      ('Pica sa sirom, mesom i povrćem', 233, 16.456, 26.96, 6.84),
      ('Pica hljeb (podloga)', 325, 6.5, 54, 8.9),
      ...
      ('Pirovo brašno (pir), speltino brašno (spelta)', 338, 14.57, 70.19, 2.43),
      ('Piškoti', 391, 12, 70, 7),
      ('Pistaći (pistacija), pečeni, soljeni', 569, 21.05, 27.55, 45.82),
      ('Pita zeljanica', 207, 9.24, 29.12, 6.54),
      ('Pivo sa voćnim sokom 2% (radler)', 43, 0.1, 7.7, 0.2),
      ...
      ('Pomfrit, kućna priprema, smrznut, pečen u pećnici', 134, 2.6, 27.8, 5.2),
      ...
      ('Protein bar, kakao punjenje, Tekmar', 376, 25, 37.8, 15.8),
      ...
      ('Pure IsoWhey, GymBeam, Vanilla ice cream', 410, 88, 6.8, 2.8),
      ...
      ('Puretina, pureći ćevapčići (ćevapi), Vindon', 182, 17, 2.3, 11),
      ('Puter od indijskog oraha, Lučar', 612, 32.1, 19.1, 45.3),
      ...
      ('Raštan kuvan', 33, 2.71, 5.65, 0.72),
      ('Raštan sirov', 36, 2.97, 7.1, 0.41),
      ...
      ('Rezanci (nudle), od jaja, suvi', 384, 14.16, 71.27, 4.44),
      ('Rezanci (nudle), od riže, kuvani', 108, 1.79, 24.01, 0.2),
      ('Rezanci (nudle), od riže, suvi', 364, 5.95, 80.18, 0.56),
      ('Rezanci, tjestenina (s jajima), Ragusa', 361, 12.4, 75, 1.3),
      ('Ribizl crni', 63, 1.4, 15.38, 0.41),
      ('Ribizl crveni i bijeli', 56, 1.4, 13.8, 0.2),
      ('Riblja ikra', 143, 22.32, 1.5, 6.42),
      ('Riblja ikra, kuvana', 204, 28.62, 1.92, 8.23),
      ('Rikota, polumasni sir', 174, 11.26, 3.04, 12.98),
      ('Riža, expandirana, zaslađena', 362, 7.1, 80, 2.7),
      ('Rižine pahuljice', 394, 6.69, 86.22, 1.26),
      ('Rižini krekeri', 416, 10, 82.64, 5),
      ('Rižini krekeri, Fiorentini', 379, 8.8, 80.3, 1.9),
      ...
      ('Ruzmarin (ružmarin), suvi', 331, 4.88, 64.06, 15.22),
      ...
      ('Salama Poli Classic', 216, 12, 0.6, 18.3),
      ...
      ('Salata sa tunom i majonezom', 138, 7.3, 10, 7.4),
      ('Salata zelena', 13, 1.35, 2.23, 0.22),
      ('Salata, zelena, ajsberg (iceberg)', 14, 0.9, 2.97, 0.14),
      ('Salvia (kadulja), suva, mljevena', 315, 10.63, 60.73, 12.75),
      ('Šampanjac', 84, 0.07, 2.72, 0),
      ('Šampinjoni gljive (pečurke)', 22, 3.09, 3.26, 0.34),
      ('Šaran', 127, 15.8, 0.7, 6.8),
      ('Sardela konzervirana', 208, 24.62, 0, 11.45),
      ('Sardela, svježa', 160, 20, 0, 8),
      ('Sardina konzervirana (u ulju)', 334, 19.7, 0, 28.3),
      ('Sardine s povrćem, Eva, Podravka', 120, 15, 3.3, 5.7),
      ('Sardine u suncokretovom ulju, Mio Mare', 310, 18.3, 0.1, 26.2),
      ('Šargarepa (mrkva)', 41, 0.93, 9.58, 0.24),
      ('Šargarepa kuvana', 35, 0.76, 8.22, 0.18),
      ...
      ('Sir Edamer Pizza Gourmet', 255, 27, 0, 16),
      ('Sir Edamer, polutvrdi', 301, 25, 0, 22),
      ('Sir Gouda', 357, 25.5, 0, 28),
      ('Sir K Plus', 78, 13, 3, 1.5),
      ('Sir kravlji svježi (cottage)', 95, 14, 3, 3),
      ('Sir kravlji svježi (obrano)', 72, 12.4, 2.7, 1),
      ('Sir Livada', 327, 25.1, 1.4, 24.5),
      ('Sir mladi u salamuri', 66, 13, 2, 0.5),
      ('Sir posni, Ella', 55, 12, 1, 0),
      ('Sir proteinski', 80, 15, 2.2, 1.5),
      ('Sir skuta, posni', 68, 11.8, 4, 0.3),
      ('Sir svježi, Quark Natur Fit', 60, 10, 4.5, 0.1),
      ('Sir topljeni, okus Gauda', 235, 13, 7.5, 17),
      ('Sir u listićima, Lactima', 299, 15, 8, 23),
      ...
      ('Sir, Mozzarella, djelimično obrano mlijeko', 254, 24.26, 2.77, 15.92),
      ('Sir, Mozzarella Premium, Paladin', 265, 19, 1.7, 20),
      ('Sir, Mozzarella, Meggle', 228, 17.5, 0.8, 17),
      ('Sir, Mozzarella, neobrano punomasno mlijeko', 299, 22.17, 2.4, 22.14),
      ...
      ('Sir, svježi, kravlji, punomasni', 251, 16.1, 2.7, 19.5),
      ...
      ('Sir, Trapist Natur, polutvrdi', 329, 23, 0.5, 26),
      ('Sir, tvrdi, 32% mm, ribani', 368, 32, 0, 26),
      ...
      ('Sladoled Quattro Forte, okus lješnjak/čokolada/straćatela, Ledo', 217, 3.5, 24.83, 11.33),
      ...
      ('Sladoled, Gellato, Sicilian-Style, okus vanilija', 141, 4.2, 0.2, 10.7),
      ...
      ('Sladoled, okus čokolada/vanilija/jagode, Carte Dor', 181, 2.9, 25, 7.1),
      ('Sladoled, okus jagode, Carte Dor', 166, 2.5, 27, 5.3),
      ...
      ('Sos od bijelog luka BURCU', 12, 1, 3, 0),
      ('Sos Barbecue Delicates Sauce Polimark', 118, 1.5, 24, 1.8),
      ('Sos Chili Polimark', 73, 0.4, 8.8, 4),
      ('Sos Indijski Curry dm Bio', 95, 1.6, 8.3, 5.5),
      ('Sos Meksička Salsa Hot Spicy Remia', 84, 1.4, 17, 0.3),
      ('Sos Meksička Salsa THOMY', 86, 1.6, 18, 0.5),
      ('Sos od paradajza sa pečenom paprikom dm Bio', 48, 1.3, 5, 2.3),
      ('Sos Salsa Mexican Style Kuhne', 104, 1.2, 22, 0.1),
      ('Sos od jabuka kućna priprava', 70, 0, 18, 0),
      ('Sos paradajz origano bosiljak Polimark', 27, 0.9, 5.5, 0.1),
      ...
      ('Špinat kuvan, baren, bez soli', 23, 2.97, 3.75, 0.26),
      ('Spirulina alga u prahu, suva', 290, 57.47, 23.9, 7.72),
      ...
      ('Svinjski vrat, suvi (sušeni), sumo meso', 450, 20.8, 1.4, 40.2),
      ...
      ('True Whey GymBeam Chocolate', 379, 74, 8.5, 4.7),
      ...
      ('Vegan protein, Chocolate Flavour, Proteini.si', 394, 64, 9.8, 9.9),
      ...
      ('Voćni sos, mix, Nutrino Lab', 85, 1.1, 16, 0.9),
      ('Vodka', 231, 0, 0, 0),
      ...
      ('Whey protein, Isolate, Pure Series, Bulk Powders', 382, 87, 4, 2),
      ('Whey protein, Vanile flavor, Pure Series, Bulk Powders', 417, 77.2, 7.8, 7.5),
      ('Žablji kraci', 73, 16.4, 0, 0.3),
      ('Želatin', 61, 1.2, 14, 0),
      ('Zimska kobasica', 535, 21, 0, 50),
      ('Zobene pahuljice, krupne, Biofor', 392, 10.94, 68.8, 7.73),
